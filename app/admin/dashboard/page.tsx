...
export default function AdminDashboard() {
  ...
  const uniqueSiniflar = Array.from(new Set(basvurular.map(b => b.sinif))).sort()

  const filteredBasvurular = basvurular.filter((b) => {
    const search = searchTerm.toLowerCase()
    const matchesSearch = !searchTerm || (
      b.adSoyad.toLowerCase().includes(search) ||
    ...
    const matchesSinif = !filterSinif || b.sinif === filterSinif
          ...
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                Bilgi Formu - Karbon Kurs Plus {session?.user?.kurumSube} Şubesi
              </h1>
          ...
          <div className="flex items-center space-x-4 mb-4">
            <div className="relative flex-1">
              <input
                ...
                placeholder="Ad soyad, telefon veya okul ile ara..."
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Okul</th>
                  ...
                  filteredBasvurular.map((basvuru, index) => (
                    ...
                    >
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-medium text-gray-900">{basvuru.adSoyad}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{basvuru.sinif}</td>
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900 max-w-xs truncate" title={basvuru.okul}>{basvuru.okul}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{basvuru.telefon}</td>
          ...
          >
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <p className="font-medium text-gray-900">{selectedBasvuru.adSoyad}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Sınıf</p>
                <p className="font-medium text-gray-900">{selectedBasvuru.sinif}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-medium text-gray-900">{selectedBasvuru.telefon}</p>
              </div>
              <div>
